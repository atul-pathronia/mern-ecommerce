...
export const ADMIN_USER_DETAILS_UPDATE_REQUEST =
  "ADMIN_USER_DETAILS_UPDATE_REQUEST";
export const ADMIN_USER_DETAILS__UPDATE_SUCCESS =
  "ADMIN_USER_DETAILS_UPDATE_SUCCESS";
export const ADMIN_USER_DETAILS__UPDATE_FAIL = "ADMIN_USER_DETAILS_UPDATE_FAIL";
export const ADMIN_USER_DETAILS__UPDATE_RESET =
  "ADMIN_USER_DETAILS_UPDATE_RESET";
